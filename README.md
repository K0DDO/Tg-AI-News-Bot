...
Постоянная клавиатура: Новости · Поиск · Каналы · Настройки · Тренды.

Лента — **одно** сообщение (до 5 заголовков), детали — карусель.
Поиск в стиле Perplexity (AI-ответ + источники).
