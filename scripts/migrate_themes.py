"""Reclassify Event.category via classify_event_text / normalize_category (10 themes)."""
...
from app.services.categories import classify_event_text, normalize_category
...
async def main() -> None:
    ...
    async with sf() as session:
        ...
        for event in events:
            ...
            # First map legacy key, then reclassify from text
            baseline = normalize_category(old)
