...
class ReactionService:
    ...
    async def set_reaction(self, user_id: int, event_id: int, reaction_type: str) -> Reaction:
...
class UserReactionService(ReactionService):
    """Named alias for architecture diagram."""
